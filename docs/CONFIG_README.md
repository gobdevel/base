...
The configuration system seamlessly integrates with the base logger system. See [LOGGER_README.md](LOGGER_README.md) for detailed logger documentation.
...
target_link_libraries(your_target tomlplusplus::tomlplusplus base)
```
