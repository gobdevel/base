# Crux Framework Performance Testing & Benchmarks

This directory contains comprehensive performance testing and benchmarking tools for the Crux framework.
...
./build/Release/tests/test_crux --gtest_filter="*Performance*"
```
...
crontab -e
0 2 * * * cd /path/to/crux/benchmarks && ./run_daily_benchmarks.sh
```
